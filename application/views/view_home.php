            ...
            <div class="col-12">
                <div class="blog-carousel owl-carousel">                    
                    ...
                    foreach ($all_news_category as $news) {
                        ...
                        if($dt[1] == '01') {$month = 'Январь';}
                        if($dt[1] == '02') {$month = 'Февраль';}
                        if($dt[1] == '03') {$month = 'Март';}
                        if($dt[1] == '04') {$month = 'Апрель';}
                        if($dt[1] == '05') {$month = 'Май';}
                        if($dt[1] == '06') {$month = 'Июнь';}
                        if($dt[1] == '07') {$month = 'Июль';}
                        if($dt[1] == '08') {$month = 'Август';}
                        if($dt[1] == '09') {$month = 'Сентябрь';}
                        if($dt[1] == '10') {$month = 'Октябрь';}
                        if($dt[1] == '11') {$month = 'Ноябрь';}
                        if($dt[1] == '12') {$month = 'Декабрь';}
                        $year = $dt[0];
                        $day = $dt[2];
                        ?>
